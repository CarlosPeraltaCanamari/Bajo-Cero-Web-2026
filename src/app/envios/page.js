        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.45)', lineHeight: 1.6, margin: 0 }}>
              Abastecemos diariamente a la Ciudad Blanca. El pedido se entrega en la dirección indicada al día siguiente de su confirmación.
            </p>
          ...
          >
            ...
            <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.45)', lineHeight: 1.6, margin: 0 }}>
              Atendemos de forma directa en las principales zonas residenciales y comerciales de Santa Cruz, manteniendo tu hidratación en el clima tropical.
            </p>
            <div style={{ height: '1px', background: 'rgba(255,255,255,0.08)' }} />
            <div>
              <h4 style={{ fontSize: '11px', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '1px', color: 'rgba(255,255,255,0.4)', marginBottom: '12px' }}>Zonas de Cobertura Activa:</h4>
